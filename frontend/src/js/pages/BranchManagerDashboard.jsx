...
import { LayoutDashboard, Tag, Package, AlertTriangle, Users, Building2, MessageSquare, Activity, ShoppingCart, BarChart3, ArrowRight } from 'lucide-react';
...
export default function BranchManagerDashboard() {
    ...
    useEffect(() => {
        ...
        async function loadData() {
            try {
                ...
                // Use user's branch for stats
                const params = userRes.data.branch_id ? { branch_id: userRes.data.branch_id } : {};
    ...
    const userBranch = stats?.branches?.find(b => b.id === user?.branch_id);
            ...
            <div className="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400">
                        Manage your branch: {userBranch?.name || 'No Branch Assigned'}
                    </p>
                </div>
            </div>
